...
ForEach ($Domain in $Domains) {
    ...
    $Rules | Where { ( $_.forwardAsAttachmentTo –ne $NULL  ) –or ( $_.forwardTo –ne $NULL ) –or ( $_.redirectTo –ne $NULL ) } | ft name,identity,ruleidentity | Export-Csv -Append MailboxForwardingRules2.csv
