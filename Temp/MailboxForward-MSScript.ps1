...
ForEach ($Domain in $Domains) {
    ...
    $UserInboxRules | Export-Csv -Append MailForwardingRulesToExternalDomains.csv
    $UserDelegates | Export-Csv -Append MailboxDelegatePermissions.csv
    $SMTPForwarding | Export-Csv -Append Mailboxsmtpforwarding.csv
